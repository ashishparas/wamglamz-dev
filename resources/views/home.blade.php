...
<div class="col-xl-3 col-xxl-4 col-sm-4">
						<div class="card invoice-card align-items-center">
							<div class="card-body">
                                    <div class="mx-auto flat-block mb-3 mt-3">
								<div class="icon flat-icon-block">
									<i class="flaticon-381-user text-center"></i>
								</div>
                            </div>
									<h2 class="invoice-num text-center"><?php echo $user ?></h2>
									<p class="fs-16 text-center w-100">Total User Registered</p>
						...
						<div class="card invoice-card align-items-center">
							<div class="card-body">
								...
								<div class="icon flat-icon-block">
									...
									<path fill-rule="evenodd"  fill="rgb(76, 77, 92)"
									...
									<h2 class="invoice-num text-center"><?php echo $artist; ?></h2>
									<span class="fs-16 text-center">Total Number of Barbers</span>
							</div>
						</div>
					</div>
					<div class="col-xl-3 col-xxl-4 col-sm-4">
						<div class="card invoice-card align-items-center">
							<div class="card-body">
								...
								<div class="icon flat-icon-block">
									...
									<h2 class="invoice-num text-center"><?php echo $booking; ?></h2>
									<span class="fs-16 text-center">Total Number of Booking</span>
